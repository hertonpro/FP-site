                ...
                <div class="row m-2">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input name="denomination" type="texte" value="<?php if (isset($projet)) {
                                    echo $projet->denomination;
                                } else {
                                    echo 'Entre titre';
                                } ?>" class="form-control">
                        </div>
...
>>>>>>> Stashed changes
                        ...
                        <div class="col-6">
                            <select  class="chosen-select" multiple style="width:350px;" tabindex="4"  
                                @if (isset($projet))
<<<<<<< Updated upstream
                                data-placeholder="{{$projet->pillier_id}}"
                                @else
                                data-placeholder="Selectionner le pillier..."
                                @endif name="pillier_id">
...
>>>>>>> Stashed changes
                        ...
                        @php
<<<<<<< Updated upstream
                            if (isset($projet)){echo $projet->pillier_id;}
=======
                            if (isset($projet)){echo $projet->pilier_id;}
>>>>>>> Stashed changes
                        @endphp 
                        <label> <strong>Bailleur</strong> </label><br>
                        <div class="col-6">
                            <select @if (isset($projet))
                            data-placeholder="{{$projet->bailleur_id}}"
                            @else
                            data-placeholder="Selectionner le bailleur..."
                            @endif 
                        ...
                        <button type="button" class="btn btn-sm btn-primary m-3" data-toggle="modal"
...
>>>>>>> Stashed changes
                            ...
                            <label for="exampleFormControlSelect1"><strong>Description du projet</strong></label>
                            <div class="form-group pl-3">
                                    <textarea id="summernote" name="description"><?php if(isset($projet)){echo $projet->description; }else{ echo "Entre la description";} ?></textarea>
                            </div>
                            @error('description')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                            ...
                            {{-- <input type="text" value=""> --}}
                                <label> <strong>Pullier associer</strong> </label>
                                <div class="col-6">
                                <select class="form-select form-control form-select-sm" aria-label=".form-select-sm example" value="<?php if(isset($projet)){echo $projet->pillier_id; }?>" name="pillier_id">
