                ...
                <div class="row m-2">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-6">
                                <select class="chosen-select" multiple style="width:350px;" tabindex="4" @if (isset($projet)) data-placeholder="{{ $projet->pilier_id }}"
                                @else
                                            data-placeholder="Selectionner le pilier..." @endif
                                    name="pilier_id">
                            ...
                            @if ($message = Session::get('success'))
                                ...
                                <div class="col-6">
                                    <select class="form-select form-control form-select-sm"
                                        aria-label=".form-select-sm example" value="<?php if (isset($projet)) {
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form role="bailleur" enctype="multipart/form-data" method="post"
                                                action="/Bailleur">
                                                @csrf
                                    ...
                                    <tbody>
                                        @forelse ($projets as $projet)
                                            <tr class="gradeX">
                                                ...
                                                <td> <a
                                                        href="/projet/{{ $projet->id }}">{{ $projet->denomination }}</a>
                                                </td>
                                                <td>
