                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button"
                                        data-text="{{ $article->tag }}" data-url="{{ $url }}"
                                        data-via="PanziFoundation" data-related="PanziFoundation" data-lang="fr"
            ...
            <div class="row">
                    ...
                    <div class="my-4 text-warning">
                        <ul class="list-unstyled list-inline mb-0">
                            ...
                            <li class="list-inline-item me-3"><a class="text-decoration-none" href="#!"><svg
                                        class="bi bi-facebook text-warning" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="col-md-3 mb-md-0 mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="" class="form-control rounded mt-2" id="" cols="20" rows="5"></textarea>
