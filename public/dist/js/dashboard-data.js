...
$(document).ready(function() {
	...
	if($('#area_chart').length > 0) {
        ...
        lineWidth:0,
		fillOpacity: 0.95,
		pointStrokeColors:['#97ca5a','#FFC20C'],
		behaveLikeLine: true,
		grid: false,
		hideHover: 'auto',
		lineColors: ['#97ca5a','#FFC20C'],
		resize: true,
		redraw: true,
		smooth: true,
	...
	if( $('#m_chart_4').length > 0 ){
		...
		var lineChart = Morris.Line({
				...
				pointStrokeColors: ['#FFC20C','#97ca5a','#aed67e'],
				lineColors: ['#FFC20C','#97ca5a','#aed67e'],
			});	
	}
...
var echartsConfig = function() { 
	...
	if( $('#e_chart_3').length > 0 ){
		...
		var option2 = {
			color: ['#FFC20C', '#bdbdbd','#cecece','#FFC20C','#e2e2e2'],		
			tooltip: {
				show: true,
				trigger: 'axis',
				backgroundColor: '#fff',
